...
def save_generated_document(
    ...
    # Sanitize the reference number to a safe filename token — it derives from an
    # admin-set code suffix, so restrict it to a strict allowlist to prevent any
    # "../" path traversal out of the documents directory.
    import re
